...
public class PresentPositionStatus : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.Space))
        {
            ...
            //dynamixel.write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL_ID, ADDR_PRO_GOAL_POSITION, (UInt32)Pos);
            //if ((dxl_comm_result = dynamixel.getLastTxRxResult(port_num, PROTOCOL_VERSION)) != COMM_SUCCESS)
            //{
            ...
            //// 시작
            //// Write goal position
            //dynamixel.write4ByteTxRx(port_num, PROTOCOL_VERSION, DXL11_ID, ADDR_PRO_GOAL_POSITION, (UInt32)dxl_goal_position[index]);
            //if ((dxl_comm_result = dynamixel.getLastTxRxResult(port_num, PROTOCOL_VERSION)) != COMM_SUCCESS)
            //{
            //    Debug.Log(Marshal.PtrToStringAnsi(dynamixel.getTxRxResult(PROTOCOL_VERSION, dxl_comm_result)));
            //}
            ...
            //{
            //    // Read present position
            //    dxl_present_position = (Int32)dynamixel.read4ByteTxRx(port_num, PROTOCOL_VERSION, DXL11_ID, ADDR_PRO_PRESENT_POSITION);
            //    if ((dxl_comm_result = dynamixel.getLastTxRxResult(port_num, PROTOCOL_VERSION)) != COMM_SUCCESS)
            //    {
            //        Debug.Log(Marshal.PtrToStringAnsi(dynamixel.getTxRxResult(PROTOCOL_VERSION, dxl_comm_result)));
            //    }
            ...
            //    Debug.Log("[ID: "+ DXL11_ID + "]" + "GoalPos: " + dxl_goal_position[index] + "PresPos: " + dxl_present_position);
